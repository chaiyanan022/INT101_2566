...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      System.out.println("My BMI = " + MyUtil.calculateBMI(50,50));
       System.out.println("My average = " + MyUtil.average(6, 8, 12));
      /*
   ...
   static void work04UseOfObjectClass() {
       ...
       b1.transfer(300, b2);
       System.out.println("Balance of account1 after transfer " + b1.getBalance());
       System.out.println("Balance of account2 after transfer " + b2.getBalance());
      /*
